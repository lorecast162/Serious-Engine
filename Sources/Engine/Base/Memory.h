...
ENGINE_API extern long GetFreeMemory( void );

/* Allocate a block of memory - fatal error if not enough memory. */
ENGINE_API extern void *AllocMemory( long memsize );
ENGINE_API extern void *_debug_AllocMemory( long memsize, int iType, const char *strFile, int iLine);
ENGINE_API extern void *AllocMemoryAligned( long memsize, long slAlignPow2);
/* Free a block of memory. */
ENGINE_API extern void FreeMemory( void *memory);
ENGINE_API extern void FreeMemoryAligned( void *memory);

ENGINE_API extern void ResizeMemory( void **memory, long memsize );
ENGINE_API extern void GrowMemory( void **memory, long memsize );
ENGINE_API extern void ShrinkMemory( void **memory,long memsize );
