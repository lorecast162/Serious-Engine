...
void ToggleFlag(CTIButton *ptib, CPoint pt, CDrawPort *pdp)
{
  ...
  if( iLayer!=-1)
  {
    ...
    if(ptlLayer!=NULL)
    {
      BOOL bOldValue=*(BOOL*)((UBYTE*)ptlLayer+(unsigned long)ptib->tib_pfData1);
      bOldValue=!bOldValue;
      *(BOOL*)((UBYTE*)ptlLayer+(unsigned long)ptib->tib_pfData1)=bOldValue;
    }
  }
}
...
CTString GetNormalizedPercentageInfo(CTIButton *ptib, CPoint pt, CDrawPort *pdp, BOOL bLmb)
{
  ...
  if( iLayer!=-1)
  {
    ...
    if(ptlLayer!=NULL)
    {
      FLOAT *pfNormalized=(FLOAT *)((UBYTE*)ptlLayer+(unsigned long)ptib->tib_pfData1);
